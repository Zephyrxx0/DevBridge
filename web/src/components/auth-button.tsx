...
export function AuthButton() {
  ...
  if (!user) {
    return (
      <Button variant="outline" size="sm" onClick={signIn} className="h-9 gap-2 rounded-lg px-3.5 border-white/[0.08] bg-[color-mix(in_oklab,var(--surface-2)_30%,transparent)] hover:bg-white/[0.06]">
